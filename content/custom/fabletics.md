...
{{< section_wrapper class="hero-grid" >}}
    ...
    {{< copy_wrapper class="hero-grid__copyBlock" >}}
     I created this web page to highlight my expertise and demonstrate my qualifications for the Sr. UX Design position at Fabletics. I believe my experience and dedication to the User Experience craft makes me an excellent candidate for the position on offer at Fabletics. Please see the samples below demonstrating my fitness for the position.
    {{< /copy_wrapper>}}
{{< /section_wrapper>}}
