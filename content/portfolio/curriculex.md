...
##
portfolioHeroAlt: 'An image of a variety low fidelity screens for the Curriculex project'
...
{{< section_wrapper class="details-grid" section-header="Design Discovery and Research" >}}
  {{< section_header level="2" text="Design Discovery and Research" >}}
      ...
      {{< image_cld
        ...
        alt=""
        figcaption="A mid-fidelity screen for an instructor's overview screen. Outlining assignments, a navigation, roster and relevant instructional libraries"
