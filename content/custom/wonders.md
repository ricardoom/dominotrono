...
{{< section_wrapper class="details-grid" >}}
    ...
    {{< section_header level="2" text="New York Public Library" >}}
     {{< image_cld 
      ...
      data-src="https://res.cloudinary.com/toupeeproofbullets/image/upload/t_portfolio_3x,q_auto,f_auto/v1548722310/nypl-dot-org/desktop.png"
    >}}
