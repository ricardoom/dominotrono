...
{{< section_wrapper class="hero-grid" >}}
    ...
    {{< copy_wrapper class="hero-grid__copyBlock" >}}
     I created this web page to showcase my qualifications for the Senior Designer role at Work & Co. The following examples demonstrate my experience in Interface and UX design.
    {{< /copy_wrapper>}}
{{< /section_wrapper>}}
{{< section_wrapper class="details-grid" >}}
    ...
    {{< copy_wrapper
      ...
      My work at Pearson involved using an internal eText authoring environment called "Bronte." My user experience responsibilities focused specifically on the publishing workflow and administration.
    {{< /copy_wrapper>}}
{{< /section_wrapper>}}
{{< section_wrapper class="details-grid" >}}
