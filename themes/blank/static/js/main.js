...
///// svg.js
/////
const svgJsContainer = document.querySelector('.svgjs');

if (svgJsContainer != null) {
  //console.log(svgContainer);

  const canvas = SVG(svgJsContainer)
      .size('100%', '100%')
...
if (homePage != null) {
  ...
  function twitterResponse() {
    ...
    let theResponse =
      'cactus girls #summeratcamp #imaginestudios #cactus #create';
